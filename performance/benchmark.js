...
;(function() {
  ...
  // Export Benchmark.
  // Simplified export that ensures Benchmark is always available globally
  const {Suite, Benchmark} = runInContext();

  // Make sure Benchmark and Suite are available in all environments
  ...
  // Still return the objects from the IIFE for AMD support
