        ...
        value.replace(
            ...
            function (_match, startTag, attrs, selfClosed, endTag, text) {
                if (startTag) {
                    const element =
                        xmlns == null
                            ? $window.document.createElement(startTag)
                            : $window.document.createElementNS(xmlns, startTag)
                    attrs.replace(
                        /\s+?([^=]+?)=(?:"([^"]*?)"|'([^']*?)'|([^\s>]*))/g,
                        function (_match: string, key: string, doubleQuoted: string, singleQuoted: string, unquoted: string) {
            ...
            createElement: function (tag: string) {
                ...
                const element: any = {
                    ...
                    set className(value: string) {
                        if (this.namespaceURI === 'http://www.w3.org/2000/svg')
                            throw new Error('Cannot set property className of SVGElement')
                    ...
                    addEventListener: function (type: string, handler: any, options?: any) {
                        ...
                        if (arguments.length > 2) {
                            if (typeof options === 'object' && options != null)
                                throw new TypeError('NYI: addEventListener options')
                        ...
                        try {
                            ...
                            if (!prevented) {
                                if (
                                    ...
                                    this.attributes['type'].value === 'checkbox' &&
                                    e.type === 'click'
                                ) {
                ...
                if (element.nodeName === 'INPUT') {
                    ...
                    Object.defineProperty(element, 'checked', {
                        get: function () {
                            return checked === undefined ? this.attributes['checked'] !== undefined : checked
                        },
                        set: function (value: any) {
                    ...
                    Object.defineProperty(element, 'type', {
                        get: function () {
                            ...
                            return /^(?:radio|button|checkbox|color|date|datetime|datetime-local|email|file|hidden|month|number|password|range|research|search|submit|tel|text|url|week|image)$/.test(
                                type,
                            )
                                ? type
                                : 'text'
                ...
                if (element.nodeName === 'CANVAS') {
                    Object.defineProperty(element, 'width', {
                        get: function () {
                            return this.attributes['width'] ? Math.floor(parseInt(this.attributes['width'].value) || 0) : 300
                        },
                        set: function (value: any) {
                    ...
                    Object.defineProperty(element, 'height', {
                        get: function () {
                            return this.attributes['height'] ? Math.floor(parseInt(this.attributes['height'].value) || 0) : 300
                        },
                        set: function (value: any) {
                ...
                function getOptions(element: any): any[] {
                    ...
                    for (let i = 0; i < element.childNodes.length; i++) {
                        ...
                        else if (element.childNodes[i].nodeName === 'OPTGROUP')
                            options = options.concat(getOptions(element.childNodes[i]))
                    }
                    return options
                }
                ...
                if (element.nodeName === 'SELECT') {
                    ...
                    Object.defineProperty(element, 'selectedIndex', {
                        get: function () {
                            return getOptions(this).length > 0 ? selectedIndex : -1
                        },
