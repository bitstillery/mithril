...
You DON'T need to call it if data is modified within the execution context of an event handler defined in a Mithril.js view. The [autoredraw](autoredraw.md) system, which is built on top of `m.redraw()`, will take care of it.
