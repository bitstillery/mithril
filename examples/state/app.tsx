        ...
        return (
            <div style='max-width: 1400px; margin: 0 auto; padding: 20px;'>
                ...
                <p style='font-size: 14px; color: #666; margin-bottom: 20px;'>
                    Comprehensive demonstration of Mithril's signal-based state system and Store persistence. Each component only
                    re-renders when its dependencies change (fine-grained reactivity).
                </p>
                ...
                {tabState.activeTab === 'state' && (
                    <div>
                        <p style='font-size: 14px; color: #666; margin-bottom: 20px;'>
                            Demonstration of Mithril's signal-based state system. Each component only re-renders when its
                            dependencies change (fine-grained reactivity).
                        </p>
                ...
                {tabState.activeTab === 'store' && (
                    <div>
                        <p style='font-size: 14px; color: #666; margin-bottom: 20px;'>
                            Store wraps state() and adds persistence capabilities (localStorage/sessionStorage). These examples
                            demonstrate how Store differs from basic state().
                        </p>
                        <div style='display: grid; grid-template-columns: 1fr 1fr; gap: 20px;'>
                            <div>
                                <StoreBasic />
