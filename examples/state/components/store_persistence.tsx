        ...
        return (
            <div style='padding: 20px; border: 1px solid #ccc; margin: 10px;'>
                ...
                <ul style='font-size: 12px; color: #666; margin-bottom: 15px;'>
                    <li>
                        <strong>Persistent</strong> - Saved to localStorage, survives page reloads
                    </li>
                    <li>
                ...
                <div style='display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;'>
                    ...
                    <div style='background: #fff3e0; padding: 15px; border-radius: 4px;'>
                        ...
                        <p style='font-size: 11px; color: #666; margin-bottom: 10px;'>Not saved - resets on page reload</p>
                        <div style='margin-bottom: 10px;'>
                            <label style='display: block; font-size: 12px; margin-bottom: 5px;'>
                                Current View:
                                <input
