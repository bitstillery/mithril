        ...
        return (
            <div style='padding: 20px; border: 1px solid #ccc; margin: 10px;'>
                ...
                <ul style='font-size: 12px; color: #666; margin-bottom: 15px;'>
                    <li>
                        <code>store.load()</code> - Loads state from templates and localStorage
                    </li>
                    <li>
                        <code>store.save()</code> - Saves persistent state to localStorage
                    </li>
                    <li>
                        <code>store.state</code> - Access reactive state (works like state())
                    </li>
