...
class DisplayValue extends MithrilComponent<DisplayValueAttrs> {
    view(vnode: Vnode<DisplayValueAttrs>) {
        ...
        return <div style='padding: 10px; background: #e3f2fd; border-radius: 4px; margin: 5px 0;'>Value: {signal.value}</div>
    }
}
        ...
        return (
            <div style='padding: 20px; border: 1px solid #ccc; margin: 10px;'>
                ...
                <ul style='font-size: 12px; color: #666;'>
                    <li>
                        <code>$s.count</code> returns the value (number)
                    </li>
                    <li>
                        <code>$s.$count</code> returns the raw Signal object
                    </li>
                </ul>
                ...
                <div style='margin-top: 15px;'>
                    ...
                    <div style='padding: 10px; background: #fff3e0; border-radius: 4px;'>Count: {$s.count}</div>
                </div>
            </div>
        )
    }
