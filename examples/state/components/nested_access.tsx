        ...
        return (
            <div style='padding: 20px; border: 1px solid #ccc; margin: 10px;'>
                ...
                <ul style='font-size: 12px; color: #666; margin-bottom: 15px;'>
                    <li>
                        <code>$s.user.name</code> - Access nested property value
                    </li>
                    <li>
                        <code>$s.user.$name</code> - Access raw signal for nested property
                    </li>
                ...
                <div style='margin-bottom: 15px;'>
                    ...
                    <div style='background: #f5f5f5; padding: 15px; border-radius: 4px;'>
                        <div style='margin-bottom: 10px;'>
                            ...
                            <br />
                            <small style='color: #666;'>Signal value: {userNameSignal.peek()}</small>
                        </div>
                        <div>
                            <strong>Email:</strong> {$s.user.email}
                            <br />
                            <small style='color: #666;'>Signal value: {userEmailSignal.peek()}</small>
                        </div>
                    </div>
                </div>
                ...
                <div style='background: #fff3e0; padding: 15px; border-radius: 4px; font-size: 11px;'>
                    ...
                    <br />
                    Changing <code style='background: white; padding: 2px 4px;'>$s.user.name</code> only triggers components that
                    access that specific property, not components accessing other user properties.
                </div>
            </div>
        )
    }
