...
export class SignalMethods extends MithrilComponent {
        ...
        return (
            <div style='padding: 20px; border: 1px solid #ccc; margin: 10px;'>
                ...
                <ul style='font-size: 12px; color: #666; margin-bottom: 15px;'>
                    <li>
                        <code>signal.subscribe(callback)</code> - Subscribe to changes
                    </li>
                    <li>
                        <code>signal.watch(callback)</code> - Watch with old/new values
                    </li>
                    <li>
                        <code>signal.peek()</code> - Access value without subscribing
                    </li>
                </ul>
